...
class ControllerModuleNewsletter extends Controller {
	...
	public function subscribed() {   
		...
		if(isset($_GET['delete']) && isset($_GET['email'])) {
			...
			$this->response->redirect($this->url->link('module/newsletter/subscribed', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['action'] = $this->url->link('module/newsletter/translation', 'token=' . $this->session->data['token'], true);
		$data['placement'] = $this->url->link('module/newsletter', 'token=' . $this->session->data['token'], true);		
		$data['settings'] = $this->url->link('module/newsletter/translation', 'token=' . $this->session->data['token'], true);
		$data['list_subscribed'] = $this->url->link('module/newsletter/subscribed', 'token=' . $this->session->data['token'], true);	
		...
		$pagination->limit = 12;
		$pagination->url = $this->url->link('module/newsletter/subscribed', 'token=' . $this->session->data['token'] . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('module/newsletter/subscribed', $data));
	}
	...
	public function translation() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->session->data['success'] = $this->language->get('text_success');
			$this->response->redirect($this->url->link('module/newsletter/translation', 'token=' . $this->session->data['token'], true));
		}
		...
		$this->response->setOutput($this->load->view('module/newsletter/translation', $data));
	}
	...
	public function index() {   
		...
		$this->response->setOutput($this->load->view('module/newsletter/placement', $data));
	}
