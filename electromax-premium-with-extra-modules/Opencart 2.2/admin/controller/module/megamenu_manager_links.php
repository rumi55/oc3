...
class ControllerModuleMegaMenuManagerLinks extends Controller {
	...
	public function link() {
		...
		if(isset($_GET['link_id'])) {
			...
			if($data == false) { 
				$this->response->redirect($this->url->link('module/megamenu_manager_links', 'token=' . $this->session->data['token'], true));
			}
			$data['name'] = $data['name'];
			$data['url'] = $data['url'];
		...
		$data['action'] = $this->url->link('module/megamenu_manager_links/link', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/megamenu_manager_links', 'token=' . $this->session->data['token'], true)
		);
		...
		$this->response->setOutput($this->load->view('module/megamenu_manager_links_edit', $data));
	...
	public function index() {  
		...
		$data['link_url'] = $this->url->link('module/megamenu_manager_links/link', 'token=' . $this->session->data['token'], true);	
		
		$data['action'] = $this->url->link('module/megamenu_manager_links', 'token=' . $this->session->data['token'], true);
		...
		$this->response->setOutput($this->load->view('module/megamenu_manager_links', $data));
	}
