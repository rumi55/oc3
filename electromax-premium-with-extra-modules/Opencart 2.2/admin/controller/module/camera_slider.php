...
class ControllerModuleCameraSlider extends Controller {
	...
	public function slider() {
		...
		if(isset($_GET['slider_id'])) {
			...
			if($data == false) { 
				$this->response->redirect($this->url->link('module/camera_slider/sliders', 'token=' . $this->session->data['token'], true));
			}
		...
		$data['action'] = $this->url->link('module/camera_slider/slider', 'token=' . $this->session->data['token'], true);
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Camera slider',
			'href' => $this->url->link('module/camera_slider', 'token=' . $this->session->data['token'], true)
		);
		...
		$this->response->setOutput($this->load->view('module/camera_slider/slider', $data));
	...
	public function sliders() {
		...
		$data['action'] = $this->url->link('module/camera_slider/sliders', 'token=' . $this->session->data['token'], true);
		$data['placement'] = $this->url->link('module/camera_slider', 'token=' . $this->session->data['token'], true);		
		$data['existing'] = $this->url->link('module/camera_slider/sliders', 'token=' . $this->session->data['token'], true);	
		$data['link_slider'] = $this->url->link('module/camera_slider/slider', 'token=' . $this->session->data['token'], true);	
		$data['token'] = $this->session->data['token'];
		...
		$this->response->setOutput($this->load->view('module/camera_slider/sliders', $data));
	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('module/camera_slider', 'token=' . $this->session->data['token'], true));
		}
		...
		$data['action'] = $this->url->link('module/camera_slider', 'token=' . $this->session->data['token'], true);
		$data['placement'] = $this->url->link('module/camera_slider', 'token=' . $this->session->data['token'], true);		
		$data['existing'] = $this->url->link('module/camera_slider/sliders', 'token=' . $this->session->data['token'], true);		
		$data['token'] = $this->session->data['token'];
		...
		$this->response->setOutput($this->load->view('module/camera_slider/placement', $data));
	}
