		  ...
		  <div class="tab-content">
			<div class="tab-pane active" id="tab-home">
			  <div class="row">
				...
				<div class="col-xs-4 text-center">
				  <a href="#tab-design" data-toggle="tab" onclick="show('#tab-design');"><i title="<?php echo $text_design; ?>" data-toggle="tooltip" class="fa fa-television fa-5x fa-fw"></i></a>
				</div>
				<div class="col-xs-4 text-center">
			  ...
			  <div class="row">
			    <div class="col-xs-4 text-center">
				  <a href="#tab-analytics" data-toggle="tab" onclick="show('#tab-analytics')"><i title="<?php echo $text_analytics; ?>" data-toggle="tooltip" class="fa fa-line-chart fa-5x fa-fw"></i></a>
				</div>
			    <div class="col-xs-4 text-center">
			  ...
			  <table class="table table-bordered table-hover table-striped">
				...
				<?php foreach ($fields as $field) { ?>
				  ...
				  <tr>
					...
					<td><input type="text" name="quickcheckout_field_<?php echo $field; ?>[placeholder]" value="<?php echo !empty(${'quickcheckout_field_' . $field}['placeholder']) ? ${'quickcheckout_field_' . $field}['placeholder'] : ''; ?>" class="form-control" /></td>
			...
			<div class="tab-pane text-center" id="tab-analytics">
			  ...
			  <a href="http://www.marketinsg.com/recover-abandoned-cart" class="btn btn-lg btn-success">More Information</a>
			  <?php } ?>
			</div>
		  </div>
		</form>
