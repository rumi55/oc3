...
<?php
global $config;
if($config->get('wlogin_fstatus') && $config->get('wlogin_gstatus') && $config->get('wlogin_lstatus') && $config->get('wlogin_tstatus')){
	...
	<div class="col-sm-12">
		<div class="well">
			...
			<div class="row wlogin_social">
				<?php if($config->get('wlogin_fstatus')){ ?>
				...
				<?php } ?>
				<?php if($config->get('wlogin_gstatus')){ ?>
				<div class="<?php echo $col ?>">
				...
				<?php } ?>
				<?php if($config->get('wlogin_lstatus')){ ?>
				<div class="<?php echo $col ?>">
				...
				<?php } ?>
				<?php if($config->get('wlogin_tstatus')){ ?>
				<div class="<?php echo $col ?>">
