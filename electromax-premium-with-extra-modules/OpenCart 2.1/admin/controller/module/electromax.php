	...
	public function index() {   
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			if(isset($_POST['button-active'])){
				...
				$this->response->redirect($this->url->link('module/electromax&submit=true&store_id=' . $data['store_id'] . '', 'token=' . $this->session->data['token'], 'SSL'));
            }
		}
			...
			if(isset($_POST['button-save'])){
				if(is_writable(DIR_CATALOG . 'view/theme/electromax/skins') && is_writable(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store']) && is_writable(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'])) {
					...
					if(file_exists(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store'].'/') == 'dir' && file_exists(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'')) {
						...
						$this->session->data['success'] = $this->language->get('text_success');
						$this->response->redirect($this->url->link('module/electromax&submit=true&store_id=' . $data['store_id'] . '&skin_edit=' . $data['active_skin_edit'] . '', 'token=' . $this->session->data['token'], 'SSL'));
					}
				}
			...
			if(isset($_POST['button-save-live-editor'])){
				...
				if(is_writable(DIR_CATALOG . 'view/theme/electromax/skins') && is_writable(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store']) && is_writable(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'])) {
					...
					if(file_exists(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store'].'/') && filetype(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store'].'/') == 'dir' && file_exists(DIR_CATALOG . 'view/theme/electromax/skins/store_'.$data['edit_skin_store'].'/'.$data['active_skin_edit'].'')) {
						...
						// Informacja o zapisaniu ustawien
						$this->session->data['success'] = $this->language->get('text_success');
						$this->response->redirect($this->url->link('module/electromax&submit=true&store_id=' . $data['store_id'] . '&skin_edit=' . $data['active_skin_edit'] . '', 'live_editor=true&store_id='.$data['store_id'].'&token=' . $this->session->data['token'], 'SSL'));
					}
				}
				
				// Jezeli nie istnieje katalog skorki to pojawia sie komunikat o bledzie
				$this->session->data['error_warning'] = 'You need to set CHMOD 777 for all folder and subfolder in catalog/view/theme/electromax/skins!';
				$this->response->redirect($this->url->link('module/electromax&submit=true&store_id=' . $data['store_id'] . '', 'live_editor=true&store_id='.$data['store_id'].'&token=' . $this->session->data['token'], 'SSL'));
			}
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {	
		     ...
		     if(isset($_POST['install_advanced_grid'])){
		     	...
		     	$this->session->data['success'] = $this->language->get('text_success');
		     	$this->response->redirect($this->url->link('module/electromax', 'token=' . $this->session->data['token'], 'SSL'));
		     }
		...
		$data['action'] = $this->url->link('module/electromax', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/electromax', 'token=' . $this->session->data['token'], 'SSL')
		);
        ...
        $data['live_editor_link'] = $this->url->link('module/electromax', 'live_editor=true&store_id='.$data['store_id'].'&token=' . $this->session->data['token'], 'SSL');
		$data['theme_options_link'] = $this->url->link('module/electromax', 'store_id='.$data['store_id'].'&token=' . $this->session->data['token'], 'SSL');	
        ...
        if(!isset($this->request->get['live_editor'])){
            ...
            $this->response->setOutput($this->load->view('module/electromax.tpl', $data));
        }else{
            $data['header'] = $this->load->controller('common/header');
            $data['footer'] = $this->load->controller('common/footer');
            ...
            $this->response->setOutput($this->load->view('module/electromax_live_editor.tpl', $data));
        }
