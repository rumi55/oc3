...
class ControllerModuleProductQuestions extends Controller {
	public function index($setting) {
        ...
        $data['contact_url'] = $this->url->link('module/product_questions/contact', '', 'SSL');
		...
		if($status) {
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/product_questions.tpl')) {
                return $this->load->view($this->config->get('config_template') . '/template/module/product_questions.tpl', $data);
            } else {
                return $this->load->view('default/template/module/product_questions.tpl', $data);
            }
        }
	}
