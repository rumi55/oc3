...
class ControllerModulePopup extends Controller {
	public function index($setting) {
		...
		$data['contact_url'] = $this->url->link('module/popup/contact', '', 'SSL');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/popup.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/popup.tpl', $data);
		} else {
			return $this->load->view('default/template/module/popup.tpl', $data);
		}
	}
     	     ...
     	     foreach($modules as $setting) {
     	          if($setting['module_id'] == $module_id) {
		               ...
		               $data['show_only_once'] = $setting['show_only_once'];
     	               ...
     	               if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/popup.tpl')) {
     	               	echo $this->load->view($this->config->get('config_template') . '/template/module/popup.tpl', $data);
     	               } else {
     	               	echo $this->load->view('default/template/module/popup.tpl', $data);
     	               }
     	          }
     	     }
	     }
