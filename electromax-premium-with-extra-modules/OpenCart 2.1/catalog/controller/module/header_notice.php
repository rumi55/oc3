...
class ControllerModuleHeaderNotice extends Controller {
	public function index($setting) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/header_notice.tpl')) {
			return $this->load->view($this->config->get('config_template') . '/template/module/header_notice.tpl', $data);
		} else {
			return $this->load->view('default/template/module/header_notice.tpl', $data);
		}
	}
}
?>