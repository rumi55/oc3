			     ...
			     <div id="product">
			      ...
			      <div class="cart clearfix">
			        ...
			        <div class="links clearfix">
			        	<a onclick="parent.wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart-o" aria-hidden="true"></i><?php echo $button_wishlist; ?></a>
			        	<a onclick="parent.compare.add('<?php echo $product_id; ?>');"><i class="fa fa-bar-chart" aria-hidden="true"></i><?php echo $button_compare; ?></a>
			        </div>
